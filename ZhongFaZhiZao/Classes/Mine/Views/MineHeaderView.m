...
- (void)initSubViews{
    ...
    //2.头像
    CGFloat iconImgH = 108 * KWidth_ScaleW;
    _headerPortraitImageView = [[UIImageView alloc] initWithFrame:CGRectMake((kScreenWidth-iconImgH) / 2.0 - 1, 55 * KWidth_ScaleW, iconImgH, iconImgH)];
...
//    [_headerPortraitImageView addGestureRecognizer:headerTap];
    ...
    //3.用户名
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, CGRectGetMaxY(_headerPortraitImageView.frame)+13*KWidth_ScaleW, kScreenWidth-40*2, 21)];
...
- (void)setPersonalInformation:(id)personalInformation{
